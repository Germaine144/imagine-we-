...
const ThingsToDo: React.FC = () => {
  ...
  const activities: Activity[] = [
    {
      id: 1,
      name: 'Join Umuganda Community Cleaning',
      category: 'social',
      description: 'Experience Rwanda\'s unique monthly community service day. Join locals in cleaning activities and community projects on the last Saturday of every month.',
      image: '/images/umuganda.jpg',
      duration: '3-4 hours',
      priceRange: '$',
      bestFor: ['Cultural Experience', 'Community Engagement', 'Making Friends'],
      icon: Users
    },
    {
      id: 2,
    ...
    {
      id: 7,
      name: 'Shopping at Kimironko Market',
      category: 'shopping',
      description: 'Immerse yourself in local life at Kigali\'s largest market. Find fresh produce, traditional crafts, fabrics, and authentic souvenirs.',
      image: '/images/kimironko-market.jpg',
      duration: '2-3 hours',
      priceRange: '$',
      bestFor: ['Bargain Hunters', 'Cultural Experience', 'Souvenir Shopping'],
      icon: ShoppingBag
    },
    {
      id: 8,
    ...
    {
      id: 9,
      name: 'Visit Nyamirambo Women\'s Center',
      category: 'social',
      description: 'Support local women entrepreneurs through guided walking tours, cooking classes, and craft workshops in the vibrant Nyamirambo neighborhood.',
      image: '/images/nyamirambo-center.jpg',
      duration: '2-3 hours',
      priceRange: '$$',
      bestFor: ['Social Impact', 'Cultural Learning', 'Community Support'],
      icon: Users
    },
    {
      id: 10,
    ...
    },
    {
      ...
      image: '/images/caplaki-craft.jpg',
      duration: '1-2 hours',
      priceRange: '$$',
