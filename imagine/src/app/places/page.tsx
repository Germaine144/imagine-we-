...
const PlacesToVisit: React.FC = () => {
  ...
  const places: Place[] = [
    ...
    {
      id: 2,
      name: 'Rebero Hill View Point',
      category: 'viewpoint',
      description: 'Amazing panoramic city views from this hidden gem. Perfect for photography and sunset watching - not a typical tourist stop!',
      image: '/images/rebero-hill.jpg',
      rating: 4.8,
    ...
    },
    {
      ...
      image: '/images/inzora-rooftop.jpg',
      rating: 4.7,
    ...
    },
    {
      ...
      image: '/images/nyarutarama-lake.jpg',
      rating: 4.4,
